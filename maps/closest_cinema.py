...
def closest_cinema(city, address):
    orig_path = os.getcwd()
    toponym_pharmacy_tochno = 'Рядом с вами нет кино или попробуйте ввести адрес подругому'
    try:
        ...
        pharmacy_map_file = f"closest_cinema_map{randint(0, 100000)}.png"
